...
function openConfig() {
	const configContainer = react.createElement(
		...
		react.createElement(OptionList, {
			items: [
				...
				{
					desc: Navify.Locale.get("artist.albums"),
					key: "album",
				...
				{
					desc: Navify.Locale.get("artist.singles"),
					key: "single-ep",
				...
				/* {
					desc: Navify.Locale.get("artist.appears-on"),
					key: "appears-on",
				...
				{
					desc: Navify.Locale.get("artist.compilations"),
					key: "compilations",
		...
		react.createElement(
			...
			react.createElement(
				...
				react.createElement(ButtonText, {
					text: Navify.Locale.get("equalizer.reset"),
	...
	Navify.PopupModal.display({
		title: Navify.Locale.get("new_releases"),
