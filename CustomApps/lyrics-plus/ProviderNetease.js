const ProviderNetease = (() => {
	...
	async function findLyrics(info) {
		...
		const searchResults = await Navify.CosmosAsync.get(finalURL, null, requestHeader);
		...
		return await Navify.CosmosAsync.get(lyricURL + items[itemId].id, null, requestHeader);
	}
