export function createScrollableContainer() {
  return (() => {
    ...
    function injectStyles() {
      ...
      style.className = "navify-scrollable-container";
      style.textContent = `
.navify-sc-contentArea { overflow: hidden; position: relative; }
.navify-sc-scroller { display: flex; align-items: center; overflow-x: auto; scrollbar-width: none; white-space: nowrap; width: 100%; -ms-overflow-style: none; overscroll-behavior-x: contain; will-change: transform; }
@media (prefers-reduced-motion: no-preference) { .navify-sc-scroller { scroll-behavior: smooth; } }
.navify-sc-scroller::-webkit-scrollbar { display: none; }
.navify-sc-scroller.navify-sc-snap { scroll-snap-type: inline mandatory; }
.navify-sc-scroller.navify-sc-snap .navify-sc-snapCenter [data-carousel-item] { scroll-snap-align: center; }
.navify-sc-scroller.navify-sc-snap .navify-sc-snapStart [data-carousel-item] { scroll-snap-align: start; }
.navify-sc-scroller.navify-sc-wheelEnabled { overscroll-behavior: contain; }
.navify-sc-scroller.navify-sc-maskGradient { --sc-start-color: #000; --sc-end-color: #000; -webkit-mask-composite: source-in, xor; mask-composite: intersect; -webkit-mask-image: linear-gradient(90deg, var(--sc-start-color) 0, #000 120px), linear-gradient(90deg, #000 calc(100% - 120px), var(--sc-end-color) 100%); mask-image: linear-gradient(90deg, var(--sc-start-color) 0, #000 120px), linear-gradient(90deg, #000 calc(100% - 120px), var(--sc-end-color) 100%); -webkit-mask-size: 100% 100%; mask-size: 100% 100%; }
.navify-sc-scroller.navify-sc-maskGradient.navify-sc-maskStart { --sc-start-color: transparent; }
.navify-sc-scroller.navify-sc-maskGradient.navify-sc-maskEnd { --sc-end-color: transparent; }
.navify-sc-linearGradient::before, .navify-sc-linearGradient::after { bottom: 0; content: ""; height: 100%; opacity: 0; pointer-events: none; position: absolute; top: 0; transition: opacity .15s ease-out; width: 120px; z-index: 2; }
.navify-sc-linearGradient::before { background: linear-gradient(90deg, var(--carousel-start-chevron-gradient, var(--spice-main)) 0, transparent 100%); inset-inline-start: 0; }
.navify-sc-linearGradient::after { background: linear-gradient(-90deg, var(--carousel-end-chevron-gradient, var(--spice-main)) 0, transparent 100%); inset-inline-end: 0; }
.navify-sc-linearGradient.navify-sc-lgStart::before { opacity: 1; }
.navify-sc-linearGradient.navify-sc-lgEnd::after { opacity: 1; }
.navify-sc-carousel { bottom: 0; left: 0; position: absolute; right: 0; top: 0; justify-content: space-between; align-items: center; display: flex; pointer-events: none; }
.navify-sc-chevronBtn { display: flex; border: none; border-radius: 50%; cursor: pointer; justify-content: center; align-items: center; backdrop-filter: var(--chevrons-button-backdrop-filter, none); background: transparent; background-color: var(--chevrons-button-color, var(--background-elevated-base)); height: 24px; opacity: 0; position: relative; transition: color .15s ease-out, opacity .15s ease-out, background-color .15s ease-out, translate .15s ease-out; translate: 0; width: 24px; z-index: 3; pointer-events: none; color: var(--text-base, #fff); }
.navify-sc-chevronBtn > * { opacity: .7; z-index: 2; }
.navify-sc-chevronBtn:hover { background-color: var(--chevrons-button-hover-color, var(--background-elevated-highlight)); }
.navify-sc-chevronBtn:hover > * { opacity: 1; }
.navify-sc-chevronBtn.navify-sc-chevronVisible { opacity: 1; pointer-events: auto; }
.navify-sc-onHover .navify-sc-chevronBtn { opacity: 0; }
.navify-sc-contentArea:hover .navify-sc-onHover .navify-sc-chevronBtn.navify-sc-chevronVisible { opacity: 1; }
.navify-sc-contentArea:hover .navify-sc-onHover .navify-sc-chevronStart.navify-sc-chevronVisible { translate: 8px; }
.navify-sc-contentArea:hover .navify-sc-onHover .navify-sc-chevronEnd.navify-sc-chevronVisible { translate: -8px; }
.navify-sc-scroller > div[role="presentation"] > button { margin-inline-start: 0px !important; }
body[data-dragging-uri-type] .navify-sc-chevronBtn { pointer-events: none; }`;
      document.head.appendChild(style);
    }

    function useDragToScroll({ isDisabled = true } = {}) {
      const { useRef, useCallback } = Navify.React;
    ...
    function useScrollState(scrollerRef, contentRef) {
      const { useState, useCallback, useEffect } = Navify.React;
    ...
    function ScrollableContainerComponent(props) {
      const { useRef, useCallback, useMemo } = Navify.React;
      const h = Navify.ReactJSX.jsx;
      const hsf = Navify.ReactJSX.jsxs;
      const cn = Navify.classnames;
      ...
      const makeChevron = (svgPath, position, visible, dir) =>
        h("div", {
          className: cn("navify-sc-chevronBtn", `navify-sc-chevron${position}`, { "navify-sc-chevronVisible": visible }),
          onClick: (e) => {
            e.preventDefault();
            e.stopPropagation();
            navigate(dir);
      ...
      return hsf("div", {
        className: cn("navify-sc-contentArea", className, {
          "navify-sc-linearGradient": isLinearGradient,
          "navify-sc-lgStart": isLinearGradient && canGoStart,
          "navify-sc-lgEnd": isLinearGradient && canGoEnd,
        }),
        children: [
          h("div", {
            ref: scrollerRef,
            className: cn("navify-sc-scroller", scrollerClassName, {
              "navify-sc-snap": isSnap,
              "navify-sc-maskGradient": isMask,
              "navify-sc-wheelEnabled": wheelScrollEnabled,
              "navify-sc-maskStart": isMask && canGoStart,
              "navify-sc-maskEnd": isMask && canGoEnd,
            }),
            ...
            children: h("div", {
              ...
              className: cn(scrollContentClassName, {
                "navify-sc-snapStart": scrollSnapAlign === "start",
                "navify-sc-snapCenter": scrollSnapAlign === "center",
              }),
              children,
            }),
          }),
          showButtons !== SHOW_BUTTONS.NEVER &&
            hsf("div", {
              className: cn("navify-sc-carousel", chevronsClassName, {
                "navify-sc-onHover": showButtons === SHOW_BUTTONS.ON_HOVER,
              }),
