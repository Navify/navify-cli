...
export function createNavifyBindings({
  cache,
  chunks,
  modules,
  functionModules,
  ...
  return {
    ...
    Player: {
      ...Navify.Player,
      get origin() {
        return Navify.Platform?.PlayerAPI;
      },
    },
    GraphQL: {
      ...Navify.GraphQL,
      get Request() {
        return Navify.Platform?.GraphQLLoader || Navify.GraphQL.Handler?.(Navify.GraphQL.Context);
      },
