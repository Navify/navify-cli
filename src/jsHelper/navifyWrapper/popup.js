class _HTMLGenericModal extends HTMLElement {
  hide() {
    Navify.ReactDOM.unmountComponentAtNode(this.querySelector("main"));
    this.remove();
  }
...
<div class="GenericModal__overlay" style="z-index: 100;">
    ...
    if (Navify.React.isValidElement(content)) {
      Navify.ReactDOM.render(content, main);
...
Navify.PopupModal = new _HTMLGenericModal();

Object.defineProperty(Navify, "TippyProps", {
  value: {
    delay: [200, 0],
    animation: true,
    render(instance) {
