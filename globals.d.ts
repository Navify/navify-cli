declare namespace Navify {
	...
	namespace Player {
		...
		const origin: any;
		/**
		 * Register a listener `type` on Navify.Player.
		 *
		 * On default, `Navify.Player` always dispatch:
		...
		/**
		 * Dispatches an event at `Navify.Player`.
		 *
		 * On default, `Navify.Player` always dispatch
		 *  - `songchange` type when player changes track.
		 *  - `onplaypause` type when player plays or pauses.
	 ...
	 *
	 * Navify.Keyboard is wrapper of this library to be compatible with legacy Spotify,
	...
	namespace ReactComponent {
		type ContextMenuProps = {
			 ...
			 */
			menu:
				| typeof Navify.ReactComponent.Menu
				| typeof Navify.ReactComponent.AlbumMenu
				| typeof Navify.ReactComponent.PodcastShowMenu
				| typeof Navify.ReactComponent.ArtistMenu
				| typeof Navify.ReactComponent.PlaylistMenu;
			/**
		 ...
		 *
		 * Props:
		 * @see Navify.ReactComponent.ContextMenuProps
		 */
		 ...
		 *
		 * Props:
		 * @see Navify.ReactComponent.MenuProps
		 */
		const Menu: any;
		/**
		 ...
		 *
		 * Props:
		 * @see Navify.ReactComponent.MenuItemProps
		 */
		const MenuItem: any;
		/**
		 ...
		 *
		 * Props:
		 * @see Navify.ReactComponent.TooltipProps
		 */
		 ...
		 *
		 * Props:
		 * @see Navify.ReactComponent.IconComponentProps
		 */
		 ...
		 *
		 * Props:
		 * @see Navify.ReactComponent.TextComponentProps
		 */
		 ...
		 *
		 * Props:
		 * @see Navify.ReactComponent.ConfirmDialogProps
		 */
		 ...
		 *
		 * Props:
		 * @see Navify.ReactComponent.SliderProps
		 */
		const Slider: any;
		/**
		 ...
		 *
		 * Props:
		 * @see Navify.ReactComponent.ButtonProps
		 */
	...
	const Tippy: any;
	/**
	 * Navify's predefined props for Tippy.js
	...
	/**
	 * Navify's QraphQL wrapper for Spotify's GraphQL API endpoints
	 */
	namespace GraphQL {
		/**
		 ...
		 * @description A preinitialized version of `Navify.GraphQL.Handler` using current context.
